      ...
      <span className="about-me-container">
        ...
        <span className="about">
          <span className="description-block">
            ...
            time. You can find examples in the <Link to="/projects">projects</Link> page.
            <br /><br />
            ...
            examples of my work on my <Link to="/art">art</Link> and <Link to="/photos">photography</Link> pages.
          </span>
        </span>
      </span>
    );
